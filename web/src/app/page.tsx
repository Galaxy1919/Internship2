    ...
    <div>
      ...
      <section className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div className="mt-5 flex items-center gap-1 text-sm font-semibold" style={{ color: "#4ade80" }}>
            进入单机实验
        ...
        >
          ...
          <div className="mt-5 flex items-center gap-1 text-sm font-semibold" style={{ color: "#22d3ee" }}>
            进入双机加解密
            <span className="transition group-hover:translate-x-1">→</span>
          </div>
        </Link>
